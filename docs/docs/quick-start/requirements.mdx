...
3. **Network**: A public IP address with a minimum download speed of 200 Mbps and upload speed of 50 Mbps.
4. **Ports**: All ports must be available for the LooPIN network.
5. **RAM**: At least 8GB * number of GPUs.
6. **Disk Space**: At least 250GB per GPU.
...
| GPU        | RTX 5090   | RTX 4090   | RTX 3090   | A100       | A5000      | A6000      | H100       |
|------------|------------|------------|------------|------------|------------|------------|------------|
