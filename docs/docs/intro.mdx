...
<div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', flexWrap: 'wrap' }}>
    <a href="https://www.barchart.com/story/news/28366100/loopin-revolutionizes-gpu-sharing-with-pinfi-protocol-for-ai-computing" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', margin: '10px', textDecoration: 'none', color: 'inherit' }}>
        <img src={barchart} alt="Barchart" style={{ width: '170px', marginRight: '5px' }} />
    </a>
    <a href="https://www.benzinga.com/content/40687808/loopin-revolutionizes-gpu-sharing-with-pinfi-protocol-for-ai-computing" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', margin: '10px', textDecoration: 'none', color: 'inherit' }}>
        <img src={benzinga} alt="Other Report Logo" style={{ width: '170px', marginRight: '5px' }} />
    </a>
    <a href="https://www.theglobeandmail.com/investing/markets/markets-news/Globe-PR-Wire/28339298/loopin-revolutionizes-gpu-sharing-with-pinfi-protocol-for-ai-computing/" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', margin: '10px', textDecoration: 'none', color: 'inherit' }}>
        <img src={theglobeandmail} alt="Other Report Logo" style={{ width: '170px', marginRight: '5px' }} />
    </a>
    <a href="https://www.digitaljournal.com/pr/news/binary-news-network/loopin-revolutionizes-gpu-sharing-pinfi-1796577597.html" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', margin: '10px', textDecoration: 'none', color: 'inherit' }}>
        <img src={digitalJournal} alt="Other Report Logo" style={{ width: '170px', marginRight: '5px' }} />
    </a>
</div>