...
[LooPro AI](https://loopro.ai) is the tech team to support the development of LooPIN network. It's a U.S. registered C-corp running AI consulting and datacenter business.
